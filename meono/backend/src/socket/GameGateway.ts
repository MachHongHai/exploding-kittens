...
import { AIBotController } from '../game/AIBot';
import { PlayerAction } from '../../../shared/src/types';
...
export class GameGateway {
  ...
  private botDifficulty: 'EASY' | 'MEDIUM' | 'HARD' = 'EASY';
  ...
  private setupListeners() {
    this.io.on('connection', (socket: Socket) => {
      ...
      socket.on('join_match', (data: { name: string, difficulty: 'EASY' | 'MEDIUM' | 'HARD', botCount?: number }) => {
        this.clearAllTimers();
